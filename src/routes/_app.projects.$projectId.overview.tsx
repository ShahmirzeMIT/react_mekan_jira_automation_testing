...
export default function OverviewPage() {
  ...
  if (!projectId) return <ProjectRequiredState pageName="Overview" />;
        ...
        actions={
          <>
            <Button size="sm" asChild>
              <Link to={`/projects/${projectId}/tasks`}>+ New Task</Link>
            </Button>
            {integrations.jiraConnectionChecked && !integrations.jiraConnected && (
              <Button size="sm" variant="secondary" asChild>
                <Link to={`/projects/${projectId}/tasks`}>Connect Jira</Link>
              </Button>
            )}
            <Button size="sm" variant="secondary" asChild>
              <Link to={`/projects/${projectId}/github`}>Connect GitHub</Link>
            </Button>
          </>
        }
      />
        ...
        <div className="space-y-4">
          <div className="surface p-5">
            ...
            <dl className="mt-3 space-y-2 text-sm">
              {[
                ["AI Assisted Tasks", 15],
                ["AI Suggestions Accepted", 38],
                ["AI Generated Code Changes", 24],
                ["AI Reviews", 12],
              ].map(([k, v]) => (
          ...
          <div className="surface p-5">
            ...
            <dl className="mt-3 space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <dd className="font-mono text-success">18</dd>
              </div>
              <div className="flex justify-between">
